    ...
    <div className="min-h-screen bg-dark-950 relative overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center px-4 py-20">
          ...
          >
            <motion.div variants={fadeInUp} transition={{ duration: 0.6 }} className="mb-6">
              <motion.div 
      ...
      <section className="py-20 bg-dark-900/30">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-xl text-white/70 max-w-2xl mx-auto">
              Join thousands of artists who've simplified their booking process
            </motion.p>
          </motion.div>
            ...
            {[
              {
                ...
                quote: "This is exactly what the independent music scene needs. Can't wait to see it launch!",
                rating: 5
              },
              {
                name: "Marcus Chen",
                ...
                quote: "Finally, a platform that understands the needs of both artists and venues.",
                rating: 5
              },
              {
                ...
                quote: "The AI-powered booking sounds revolutionary. I'm excited to be part of this!",
                rating: 5
              }
