...
ALTER TABLE venues 
ADD CONSTRAINT venues_booking_email_unique UNIQUE (booking_email) WHERE booking_email IS NOT NULL;

-- Add unique constraint on website (if not null)
ALTER TABLE venues 
ADD CONSTRAINT venues_website_unique UNIQUE (website) WHERE website IS NOT NULL; 