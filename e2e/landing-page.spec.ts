...
test.describe('Landing Page', () => {
  ...
  test('should display main landing page content', async ({ page }) => {
    ...
    await expect(page.locator('text=TheGreenRoom.ai helps independent artists and venues book smarter, faster')).toBeVisible();
  });
  ...
  test('should display navigation elements', async ({ page }) => {
    ...
    await expect(page.locator('text=AI-Powered Booking Platform')).toBeVisible();
  });
});